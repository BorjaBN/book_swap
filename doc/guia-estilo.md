...
La gama de colores escogida para BookSwap está formada por seis colores seleccionados con cuidado y que equilibran la naturaleza y la cultura gracias a la web Coolors. Esta diversidad posibilita la creación de una interfaz que sea consistente, accesible y que esté alineada desde el punto de vista emocional con los valores de la aplicación.
