...
quiero registrarme en la plataforma<br>
para poder publicitar mis eventos en la aplicación.

Criterios de aceptación:

    El usuario proporciona sus datos administrativos básicos: nombre, telefono, sitio web (opcional), correo electrónico, contraseña, dirección y ciudad.
