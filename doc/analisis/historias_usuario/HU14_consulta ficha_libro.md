...
quiero consultar la ficha de un libro<br>
para ver detalles completos antes de decidir un intercambio.
...
Criterios de aceptación:
    ...
    Si algún dato falta, se indica que no está disponible.