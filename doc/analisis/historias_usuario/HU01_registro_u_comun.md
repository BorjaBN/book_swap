...
para poder intercambiar libros y ver novedades sobre eventos culturales.

Criterios de aceptación:

    El usuario proporciona sus datos básicos (nombre, apellidos, correo electrónico, contraseña, telefono y ciudad).
