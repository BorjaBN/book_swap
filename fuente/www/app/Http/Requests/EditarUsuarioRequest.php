...
/**
 * Form Request para validar la edición del perfil tanto de usuarios comunes
 * como de entidades culturales.
 *
 * Detecta automáticamente el tipo de usuario autenticado y aplica las reglas
...
class EditarUsuarioRequest extends FormRequest
{
    ...
    /**
     * Reglas de validación para la edición del perfil.
     *
     * Determina si el usuario autenticado es un UsuarioComun o una
     * EntidadCultural y aplica las reglas específicas para cada caso.
     *
     * @return array
     */
     ...
     *
     * Incluye mensajes diferenciados para usuarios comunes y entidades culturales.
     *
     * @return array
     */
