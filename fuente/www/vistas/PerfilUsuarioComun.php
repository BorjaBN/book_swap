...
<body>
 ...
 <div class="text-center mt-4">
    ...
    <p class="text-muted" style="font-family: 'Playfair Display', serif;">Usuario</p>
  ...
  <nav class="navbar fixed-bottom bg-white border-top">
    <div class="container d-flex justify-content-around">
      <button class="btn btn-registrarse">Datos</button>
      <button class="btn btn-registrarse">Valoraciones</button>
      <button class="btn btn-registrarse">Solicitudes</button>
      <button class="btn btn-registrarse">Eventos</button>
    </div>
  </nav>
