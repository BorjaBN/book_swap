...
<body>
  ...
  <nav class="navbar fixed-bottom bg-white border-top">
    <div class="container d-flex justify-content-around">
      <button class="btn btn-link text-dark">Datos</button>
      <button class="btn btn-link text-dark">Valoraciones</button>
      <button class="btn btn-link text-dark">Solicitudes</button>
      <button class="btn btn-link text-dark">Eventos</button>
    </div>
  </nav>
